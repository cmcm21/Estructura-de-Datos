...
//definir un proceso (Se modela con una estructura "proceso" que se usa en la simulacion 2)
typedef struct proceso
{
	//Variables de la estructura "proceso" (El usuario puede modificar)
	char ID[20], Nombre[50], Actividad[100];
	int t_ejecucion, t_total;
} proceso;
